...
public class AdapterKontak extends RecyclerView.Adapter<AdapterKontak.MyViewHolder>{
    ...
    @NonNull
    @Override
    public AdapterKontak.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterKontak.MyViewHolder holder, final int position) {
